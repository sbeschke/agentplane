"""Tests for documents functionality in mops.

Ported from documents/tests.py.
"""
...
from mops.models import Collection, Document, DocumentChunk
from mops.services import (
...
class IndexDocumentTest(TestCase):
    ...
    def test_index_document_creates_chunks(self):
        ...
        try:
            ...
            self.skipTest("reportlab not installed, skipping document indexing test")
